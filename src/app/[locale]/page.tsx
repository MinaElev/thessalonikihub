      ...
      <section className="py-10">
        <Container>
          <div className="overflow-hidden rounded-3xl bg-gradient-to-r from-accent-600 to-accent-700 p-8 text-white sm:p-12">
            ...
            <Link
              href="/submit"
              className="mt-6 inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 font-semibold text-accent-700 shadow-sm transition hover:bg-accent-50"
            >
              {t("home.forBusinessCta")} <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
        </Container>
      </section>
